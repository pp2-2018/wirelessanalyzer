...
public class FilterCompabilityValidatorTest {
    ...
    public void setUp() throws Exception {
        ComponentTypeValidator componentTypeValidator = new ComponentTypeValidator(SimpleFilter.class);
        filterIOValidator = new FilterCompabilityValidator(componentTypeValidator);
    }
